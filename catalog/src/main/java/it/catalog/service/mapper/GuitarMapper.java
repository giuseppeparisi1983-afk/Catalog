...
public interface GuitarMapper {
	...
	@Mapping(target = "video.lastView", source = "lastView")
	@Mapping(target = "video.lastUpdate", source = "lastUpdate")
	...
	@Mapping(target = "lastView", source = "video.lastView")
    @Mapping(target = "lastUpdate", source = "video.lastUpdate")
